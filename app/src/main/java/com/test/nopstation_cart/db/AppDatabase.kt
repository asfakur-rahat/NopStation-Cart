...
import com.test.nopstation_cart.db.converter.OrderConverter
...
import com.test.nopstation_cart.db.dao.OrderDao
...
@Database(
    entities = [Slider::class, Category::class, Featured::class,OrderEntity::class],
    version = 1, exportSchema = false
)
@TypeConverters(Converter::class, FeaturedProductConverter::class, OrderConverter::class)
