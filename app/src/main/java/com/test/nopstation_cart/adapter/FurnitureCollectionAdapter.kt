...
class FurnitureCollectionAdapter(
    private val onClick: (ProductItem) -> Unit
): ListAdapter<ProductItem, FurnitureCollectionAdapter.ViewHolder>(DIFF_CALLBACK) {
    class ViewHolder(
    ...
    override fun onBindViewHolder(holder: FurnitureCollectionAdapter.ViewHolder, position: Int) {
