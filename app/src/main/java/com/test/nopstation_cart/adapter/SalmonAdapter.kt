...
class SalmonAdapter(
   private val onClick: (ProductItem) -> Unit
): ListAdapter<ProductItem, SalmonAdapter.SalmonViewHolder>(DiffCallback) {
    class SalmonViewHolder(
        ...
        companion object {
            fun from(
                ...
                return SalmonViewHolder(binding, onClick)
            }
        }
    ...
    override fun onCreateViewHolder(
        ...
        return SalmonViewHolder.from(parent, onClick)
    }

    override fun onBindViewHolder(holder: SalmonViewHolder, position: Int) {
